...
set_property -dict {PACKAGE_PIN N16 IOSTANDARD LVCMOS33} [get_ports {led3}]; #IO_L21N_T3_DQS_AD14N_35 Sch=led[2]
set_property -dict {PACKAGE_PIN M14 IOSTANDARD LVCMOS33 } [get_ports { led4 }]; #IO_L23P_T3_35 Sch=led[3]
...
#set_property -dict { PACKAGE_PIN U18   IOSTANDARD LVCMOS33 } [get_ports { au_mclk }]; #IO_L12P_T1_MRCC_34 Sch=ja_p[3]#
#set_property -dict { PACKAGE_PIN U19   IOSTANDARD LVCMOS33 } [get_ports {iic_rtl_sda_io }]; #IO_L12N_T1_MRCC_34 Sch=ja_n[3]
#set_property -dict { PACKAGE_PIN W18   IOSTANDARD LVCMOS33 } [get_ports { iic_rtl_scl_io }]; #IO_L22P_T3_34 Sch=ja_p[4]
#set_property -dict { PACKAGE_PIN W19   IOSTANDARD LVCMOS33 } [get_ports { ja[7] }]; #IO_L22N_T3_34 Sch=ja_n[4]

##PmodB

#set_property -dict { PACKAGE_PIN W14   IOSTANDARD LVCMOS33 } [get_ports { adau_lrclk }]; #IO_L8P_T1_34 Sch=jb_p[1]
#set_property -dict { PACKAGE_PIN Y14   IOSTANDARD LVCMOS33 } [get_ports { adau_bclk }]; #IO_L8N_T1_34 Sch=jb_n[1]
#set_property -dict { PACKAGE_PIN T11   IOSTANDARD LVCMOS33 } [get_ports { adau_adc }]; #IO_L1P_T0_34 Sch=jb_p[2]
#set_property -dict { PACKAGE_PIN T10   IOSTANDARD LVCMOS33 } [get_ports { dac_out }]; #IO_L1N_T0_34 Sch=jb_n[2]
#set_property PULLUP true [get_ports iic_sda_io];
#set_property -dict { PACKAGE_PIN V16   IOSTANDARD LVCMOS33 } [get_ports { iic_scl_io }]; #IO_L18P_T2_34 Sch=jb_p[3]
...
#set_property -dict {PACKAGE_PIN P16 IOSTANDARD LVCMOS33} [get_ports iic_scl_io]
#set_property -dict {PACKAGE_PIN P15 IOSTANDARD LVCMOS33} [get_ports iic_sda_io]
...
create_clock -name sysclk -period 25 -waveform {0 12.5} [get_ports hdmi_rx_clk_p ]
#create_clock -period 13.468 -waveform {0.000 5.000} [get_ports hdmi_rx_clk_p]
#create_clock -period 6.734 -waveform {0.000 5.000} [get_ports hdmi_rx_clk_p]
