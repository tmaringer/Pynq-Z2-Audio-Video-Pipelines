...
# module references:
# Buffers, I2S_Receiver, I2S_Transmitter, hdmi_out, AXI_Echo, AXI_Fir, AXI_Gain, AXI_Rectification, AXI_Saturation, Debounce, FlipFlops
...
proc create_hier_cell_AXI_Effects { parentCell nameHier } {
  ...
  connect_bd_net -net FlipFlops_0_out1 [get_bd_pins out1] [get_bd_pins AXI_Saturation_0/enable] [get_bd_pins FlipFlops_0/out1]
  connect_bd_net -net FlipFlops_0_out2 [get_bd_pins out2] [get_bd_pins AXI_Rectification_0/enable] [get_bd_pins FlipFlops_0/out2]
  connect_bd_net -net FlipFlops_0_out3 [get_bd_pins out3] [get_bd_pins AXI_Fir_0/enable] [get_bd_pins FlipFlops_0/out3]
  connect_bd_net -net FlipFlops_0_out4 [get_bd_pins out4] [get_bd_pins AXI_Echo_0/enable] [get_bd_pins FlipFlops_0/out4]
...
proc create_hier_cell_crossing_clock_domain_50_hdmi { parentCell nameHier } {
  ...
  # Create port connections
  connect_bd_net -net clk_wiz_0_pix [get_bd_pins dest_clk] [get_bd_pins xpm_cdc_gen_0/dest_clk]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK1 [get_bd_pins src_clk] [get_bd_pins xpm_cdc_gen_0/src_clk]
...
proc create_hier_cell_clock_domain_hdmi { parentCell nameHier } {
  ...
  create_bd_pin -dir I -type clk fast_clk
  create_bd_pin -dir I serclk
  ...
  # Create port connections
  connect_bd_net -net btn1_1 [get_bd_pins btn1] [get_bd_pins hdmi_out_0/rst]
  connect_bd_net -net clk_wiz_0_pix [get_bd_pins fast_clk] [get_bd_pins hdmi_out_0/pixclk]
  connect_bd_net -net clk_wiz_0_ser [get_bd_pins serclk] [get_bd_pins hdmi_out_0/serclk]
...
proc create_hier_cell_clock_domain_50 { parentCell nameHier } {
  ...
  # Create port connections
  connect_bd_net -net AXI_Effects_led1 [get_bd_pins led1] [get_bd_pins AXI_Effects/led1]
  connect_bd_net -net AXI_Effects_led2 [get_bd_pins led2] [get_bd_pins AXI_Effects/led2]
  connect_bd_net -net AXI_Effects_led3 [get_bd_pins led3] [get_bd_pins AXI_Effects/led3]
  connect_bd_net -net AXI_Effects_led4 [get_bd_pins led4] [get_bd_pins AXI_Effects/led4]
  ...
  connect_bd_net -net AXI_Effects_m_axis1_tdata [get_bd_pins m_axis1_tdata] [get_bd_pins AXI_Effects/m_axis1_tdata]
  connect_bd_net -net AXI_Effects_out1 [get_bd_pins out1] [get_bd_pins AXI_Effects/out1]
  connect_bd_net -net AXI_Effects_out2 [get_bd_pins out2] [get_bd_pins AXI_Effects/out2]
  connect_bd_net -net AXI_Effects_out3 [get_bd_pins out3] [get_bd_pins AXI_Effects/out3]
  connect_bd_net -net AXI_Effects_out4 [get_bd_pins out4] [get_bd_pins AXI_Effects/out4]
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.CLKOUT1_JITTER {120.231} \
   CONFIG.CLKOUT1_PHASE_ERROR {161.056} \
   CONFIG.CLKOUT1_REQUESTED_OUT_FREQ {368.75} \
   CONFIG.CLKOUT2_DRIVES {No_buffer} \
   CONFIG.CLKOUT2_JITTER {159.567} \
   CONFIG.CLKOUT2_PHASE_ERROR {161.056} \
   CONFIG.CLKOUT2_REQUESTED_OUT_FREQ {73.75} \
   ...
   CONFIG.CLK_OUT1_PORT {ser} \
   CONFIG.CLK_OUT2_PORT {pix} \
  ...
  connect_bd_net -net AXI_Effects_m_axis1_tdata -boundary_type upper [get_bd_pins clock_domain_50/m_axis1_tdata]
  ...
  connect_bd_net -net btn1_1 [get_bd_ports btn1] [get_bd_pins clock_domain_50/btn1] [get_bd_pins clock_domain_hdmi/btn1]
  ...
  connect_bd_net -net clk_wiz_0_pix [get_bd_pins clk_wiz_0/pix] [get_bd_pins clock_domain_hdmi/fast_clk] [get_bd_pins crossing_clock_domain_50_hdmi/dest_clk]
  connect_bd_net -net clk_wiz_0_ser [get_bd_pins clk_wiz_0/ser] [get_bd_pins clock_domain_hdmi/serclk]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK1 [get_bd_pins clk_wiz_0/clk_in1] [get_bd_pins clock_domain_50/s_axi_aclk1] [get_bd_pins crossing_clock_domain_50_hdmi/src_clk] [get_bd_pins processing_system7_0/FCLK_CLK1] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK]
  ...
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins clk_wiz_0/resetn] [get_bd_pins clock_domain_50/peripheral_aresetn]
