...
proc create_hier_cell_AXI_Effects { parentCell nameHier } {
  ...
  connect_bd_intf_net -intf_net [get_bd_intf_nets AXI_Fir_0_m_axis] [get_bd_intf_pins m_axis2] [get_bd_intf_pins AXI_Fir_0/m_axis]
  ...
  connect_bd_intf_net -intf_net [get_bd_intf_nets AXI_Gain_0_m_axis] [get_bd_intf_pins s_axis1] [get_bd_intf_pins AXI_Gain_0/m_axis]
  ...
  connect_bd_intf_net -intf_net [get_bd_intf_nets AXI_Rectification_0_m_axis] [get_bd_intf_pins m_axis1] [get_bd_intf_pins AXI_Rectification_0/m_axis]
  ...
  connect_bd_intf_net -intf_net [get_bd_intf_nets AXI_Saturation_0_m_axis] [get_bd_intf_pins s_axis2] [get_bd_intf_pins AXI_Saturation_0/m_axis]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets AXI_Effects_m_axis] [get_bd_intf_pins AXI_Effects/m_axis] [get_bd_intf_pins system_ila_0/SLOT_5_AXIS]
connect_bd_intf_net -intf_net Conn [get_bd_intf_pins AXI_Effects/s_axis1] [get_bd_intf_pins system_ila_0/SLOT_1_AXIS]
connect_bd_intf_net -intf_net Conn1 [get_bd_intf_pins AXI_Effects/s_axis2] [get_bd_intf_pins system_ila_0/SLOT_2_AXIS]
connect_bd_intf_net -intf_net Conn2 [get_bd_intf_pins AXI_Effects/m_axis1] [get_bd_intf_pins system_ila_0/SLOT_3_AXIS]
connect_bd_intf_net -intf_net Conn3 [get_bd_intf_pins AXI_Effects/m_axis2] [get_bd_intf_pins system_ila_0/SLOT_4_AXIS]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets I2S_Receiver_0_m_axis] [get_bd_intf_pins I2S_Receiver/m_axis] [get_bd_intf_pins system_ila_0/SLOT_0_AXIS]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK1 [get_bd_pins AXI_Effects/s_axi_aclk1] [get_bd_pins I2S_Receiver/m_axis_aclk] [get_bd_pins I2S_Transmitter/s_axis_aclk] [get_bd_pins axi_iic_0/s_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK1] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk] [get_bd_pins system_ila_0/clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_50M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins AXI_Effects/s_axi_aresetn1] [get_bd_pins I2S_Receiver/m_axis_aresetn] [get_bd_pins I2S_Transmitter/s_axis_aresetn] [get_bd_pins axi_iic_0/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn] [get_bd_pins system_ila_0/resetn]
