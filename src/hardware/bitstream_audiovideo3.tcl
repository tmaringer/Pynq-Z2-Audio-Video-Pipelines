...
proc create_root_design { parentCell } {
  ...
  # Create port connections
  connect_bd_net -net AXI_Echo_0_led_enable [get_bd_ports led3] [get_bd_pins AXI_Effects/led3] [get_bd_pins hdmi_out_0/sw2]
  connect_bd_net -net AXI_Effects_led4 [get_bd_ports led4] [get_bd_pins AXI_Effects/led4] [get_bd_pins hdmi_out_0/sw3]
  ...
  connect_bd_net -net AXI_Effects_m_axis1_tdata [get_bd_pins AXI_Effects/m_axis1_tdata] [get_bd_pins hdmi_out_0/s_axis_tdata]
  connect_bd_net -net AXI_Rectification_0_led_enable [get_bd_ports led2] [get_bd_pins AXI_Effects/led2] [get_bd_pins hdmi_out_0/sw1]
  ...
  connect_bd_net -net AXI_Saturation_0_led_enable [get_bd_ports led1] [get_bd_pins AXI_Effects/led1] [get_bd_pins hdmi_out_0/sw]
  ...
  connect_bd_net -net btn1_1 [get_bd_ports btn1] [get_bd_pins AXI_Effects/btn1] [get_bd_pins hdmi_out_0/rst]
  ...
  connect_bd_net -net hdmi_out_0_clk_n [get_bd_ports clk_n] [get_bd_pins hdmi_out_0/clk_n]
  connect_bd_net -net hdmi_out_0_clk_p [get_bd_ports clk_p] [get_bd_pins hdmi_out_0/clk_p]
  connect_bd_net -net hdmi_out_0_data_n [get_bd_ports data_n] [get_bd_pins hdmi_out_0/data_n]
  connect_bd_net -net hdmi_out_0_data_p [get_bd_ports data_p] [get_bd_pins hdmi_out_0/data_p]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK2 [get_bd_pins hdmi_out_0/clk] [get_bd_pins processing_system7_0/FCLK_CLK2]
  ...
  connect_bd_net -net sw1_1 [get_bd_ports sw1] [get_bd_pins AXI_Effects/switch_0]
