...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set btn1 [ create_bd_port -dir I -type rst btn1 ]
  ...
  connect_bd_net -net dvi2rgb_0_PixelClk [get_bd_pins dvi2rgb_0/PixelClk] [get_bd_pins ila_0/clk]
  ...
  connect_bd_net -net dvi2rgb_0_vid_pData [get_bd_pins dvi2rgb_0/vid_pData] [get_bd_pins ila_0/probe0]
  connect_bd_net -net dvi2rgb_0_vid_pHSync [get_bd_pins dvi2rgb_0/vid_pHSync] [get_bd_pins ila_0/probe1]
  connect_bd_net -net dvi2rgb_0_vid_pVDE [get_bd_pins dvi2rgb_0/vid_pVDE] [get_bd_pins ila_0/probe3]
  connect_bd_net -net dvi2rgb_0_vid_pVSync [get_bd_pins dvi2rgb_0/vid_pVSync] [get_bd_pins ila_0/probe2]
  ...
  connect_bd_net -net reset_0_1 [get_bd_ports btn1] [get_bd_pins clk_wiz_0/reset]
