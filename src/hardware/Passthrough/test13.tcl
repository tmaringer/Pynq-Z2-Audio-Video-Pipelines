...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set DDC_0_scl_io [ create_bd_port -dir I DDC_0_scl_io ]
  set DDC_0_sda_io [ create_bd_port -dir IO DDC_0_sda_io ]
  ...
  connect_bd_net -net DDC_SCL_0_1 [get_bd_ports DDC_0_scl_io] [get_bd_pins dvi2rgb_0/DDC_SCL]
  connect_bd_net -net Net [get_bd_ports DDC_0_sda_io] [get_bd_pins dvi2rgb_0/DDC_SDA]
