...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net dvi2rgb_0_PixelClk [get_bd_pins dvi2rgb_0/PixelClk] [get_bd_pins ila_0/clk] [get_bd_pins rgb2dvi_0/PixelClk]
  ...
  connect_bd_net -net dvi2rgb_0_vid_pVSync [get_bd_pins dvi2rgb_0/vid_pVSync] [get_bd_pins ila_0/probe2] [get_bd_pins ila_0/probe3] [get_bd_pins rgb2dvi_0/vid_pVSync]
