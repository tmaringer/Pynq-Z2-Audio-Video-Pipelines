...
if { $bCheckIPs == 1 } {
   set list_check_ips "\ 
digilentinc.com:ip:dvi2rgb:1.9.3\
...
proc create_root_design { parentCell } {
  ...
  set dvi2rgb_0 [ create_bd_cell -type ip -vlnv digilentinc.com:ip:dvi2rgb:1.9.3 dvi2rgb_0 ]
  set_property -dict [ list \
   ...
   CONFIG.kEnableSerialClkOutput {true} \
  ...
  connect_bd_net -net TMDS_Data_n_0_1 [get_bd_ports hdmi_rx_data_n] [get_bd_pins dvi2rgb_0/TMDS_Data_n]
  connect_bd_net -net TMDS_Data_p_0_1 [get_bd_ports hdmi_rx_data_p] [get_bd_pins dvi2rgb_0/TMDS_Data_p]
  connect_bd_net -net dvi2rgb_0_PixelClk [get_bd_pins dvi2rgb_0/PixelClk] [get_bd_pins rgb2dvi_0/PixelClk]
  connect_bd_net -net dvi2rgb_0_SerialClk [get_bd_pins dvi2rgb_0/SerialClk] [get_bd_pins rgb2dvi_0/SerialClk]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins dvi2rgb_0/RefClk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK]
  ...
  connect_bd_net -net xlconstant_0_dout [get_bd_pins dvi2rgb_0/aRst_n] [get_bd_pins dvi2rgb_0/pRst_n] [get_bd_pins rgb2dvi_0/aRst_n] [get_bd_pins xlconstant_0/dout]
